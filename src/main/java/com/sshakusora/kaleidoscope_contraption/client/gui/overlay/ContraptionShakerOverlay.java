...
public final class ContraptionShakerOverlay implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        renderContents(guiGraphics, minecraft.font, target.get().shaker(),
                guiGraphics.guiWidth() / 2 - CONTENT_X_OFFSET,
                guiGraphics.guiHeight() / 2 + CONTENT_Y_OFFSET);
    }
