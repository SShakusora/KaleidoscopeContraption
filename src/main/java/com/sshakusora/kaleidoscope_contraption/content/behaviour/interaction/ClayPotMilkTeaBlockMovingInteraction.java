...
/** Restores Cookery's disposable clay-pot milk tea block interaction on contraptions. */
public class ClayPotMilkTeaBlockMovingInteraction extends BlockEntityDelegatingMovingInteraction {
    @Override
    public boolean handlePlayerInteraction(Player player, InteractionHand hand, BlockPos localPos,
        ...
        ItemHandlerHelper.giveItemToPlayer(player, new ItemStack(info.state().getBlock()));
